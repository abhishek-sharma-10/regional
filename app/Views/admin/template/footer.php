    ...
    <!-- Data Tables JS-->
    <!-- <script src="<?php echo base_url();?>assets/js/plugins/dataTables/jquery.dataTables.js"></script> -->
    <script src="<?php echo base_url();?>assets/js/plugins/dataTables/dataTables.js"></script>
    <script src="<?php echo base_url();?>assets/js/plugins/dataTables/dataTables.bootstrap.js"></script>
    <script src="<?php echo base_url();?>assets/js/plugins/dataTables/dataTables.responsive.min.js"></script>
    <!-- <script src="<?php echo base_url();?>assets/js/plugins/dataTables/dataTables.tableTools.min.js"></script> -->
    
    <script src="<?php echo base_url();?>assets/js/plugins/dataTables/dataTables.buttons.js"></script>
    <script src="<?php echo base_url();?>assets/js/plugins/dataTables/buttons.dataTables.js"></script>
