                    	...
                    	<form name="reset_form" id="reset_form" method="post" class="form-horizontal">
                    		...
                    		<div class="form-group">
                    			<div class="col-md-6 col-md-offset-3">
                                    ...
                                    <input type="password" name="confirmpswd" class="form-control requiredfield" id="confirmpassword" data-rule-equalto="#newpassword" data-msg-equalto="Invalid Confirm Password !" data-rule-required="true"/>
                                </div>
                    		</div>
