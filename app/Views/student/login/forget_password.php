		            	...
		            	<form name="forget_form" id="forget_form" enctype="multipart/form-data" method="post" class="form-horizontal" action="<?php echo base_url(); ?>forget-password">
		            		<div class="form-group">
		            			<div class="col-md-6 col-md-offset-3">
		            				<label class="control-label">Enter Registration Number</label>
		            				<input type="text" name="username" id="username" class="form-control requiredfield" placeholder="Registration Number" data-rule-required="true"/>
		            			</div>
		            		</div>
