    ...
    <div class="main-box">
      ...
      <div class="step">
        ...
        <div class="screenshot-placeholder">
          <img src="<?= base_url('\assets\img\instruction-images\RIE_1.jpg') ?>" alt="Step 2 Screenshot" class="screenshot-img">
        </div>
      </div>
      ...
      <div class="step">
        ...
        <div class="screenshot-placeholder">
          <img src="<?= base_url('\assets\img\instruction-images\RIE_2.jpg') ?>" alt="Step 2 Screenshot" class="screenshot-img">
        </div>
      </div>
      <div class="step">
        ...
        <div class="screenshot-placeholder">
          <img src="<?= base_url('\assets\img\instruction-images\RIE_login.jpg') ?>" alt="Step 2 Screenshot" class="screenshot-img">
        </div>
      </div>
      <div class="step">
        <div class="step-title">Step 4:</div>
          ...
          <div class="screenshot-placeholder">
            <img src="<?= base_url('\assets\img\instruction-images\RIE_Guideline.jpg') ?>" alt="Step 2 Screenshot" class="screenshot-img">
        </div>
      </div>
      <div class="step">
        <div class="step-title">Step 5:</div>
          ...
          <div class="screenshot-placeholder">
            <img src="<?= base_url('\assets\img\instruction-images\RIE_Academic.png') ?>" alt="Step 2 Screenshot" class="screenshot-img">
          </div>
          ...
          <div class="screenshot-placeholder">
            <img src="<?= base_url('\assets\img\instruction-images\RIE_Print_Academic_Detail.jpg') ?>" alt="Step 2 Screenshot" class="screenshot-img">
          </div>
      ...
      <div class="step">
        <div class="step-title">Step 6:</div>
          <p>Pay Form Fees</p>
          <div class="screenshot-placeholder">
            <img src="<?= base_url('\assets\img\instruction-images\RIE_Pay_Form_Fees.jpg') ?>" alt="Step 2 Screenshot" class="screenshot-img">
          </div>
