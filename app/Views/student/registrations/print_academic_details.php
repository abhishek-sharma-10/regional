    ...
    <div class="container text-center shadow-remove">
        ...
        <div class="table-responsive mb-4">
            <table class="table table-bordered text-center">
                <thead class="table-light">
                    <tr>
                        <th width="33.33%">Maximum Marks</th>
                        <th width="33.33%">Obtained Marks</th>
                        <th width="33.33%">Percent</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
        ...
        <h4>12<sup>th</sup> (Senior Secondary)</h4>
        <div class="table-responsive mb-2">
            <table class="table table-bordered text-center">
                <thead class="table-light">
                    <tr>
                        <th width="33.33%">Board</th>
                        <th width="33.33%">Stream</th>
                        <th width="33.33%">Year of Passing</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
