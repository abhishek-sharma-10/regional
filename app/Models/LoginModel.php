...
class LoginModel extends Model {
    ...
    function getStudentLoginAccess($userDetails){
        ...
        $result = $this->db->query('SELECT registrations.* FROM registrations WHERE email = "'.$email.'" AND registrations.status != "Cancel"');
